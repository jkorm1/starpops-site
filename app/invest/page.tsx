...
import { Download, Shield, TrendingUp, Users, Target, Award } from "lucide-react"
...
export default function InvestPage() {
  ...
  const handleCalculateReturn = () => {
    ...
    if (isNaN(amount) || amount < businessData.investmentTerms.minimumInvestment) {
      toast({
  ...
  const handleGenerateProposal = () => {
    if (!businessData || !investmentAmount || !investorName || !investorEmail) {
      toast({
        title: "Missing Information",
        description: "Please fill in all required fields to generate the proposal.",
        variant: "destructive",
      })
      return
    }
    ...
    const proposalData = {
      investor: { name: investorName, email: investorEmail, message: investorMessage },
      investment: { amount: Number.parseFloat(investmentAmount), expectedReturn: calculatedReturn },
    ...
    a.href = url
    a.download = `star-pops-investment-proposal-${investorName.replace(/\s+/g, "-").toLowerCase()}.json`
    ...
    toast({
      ...
      description: "Your investment proposal has been downloaded. Please email it to us for review.",
    })
  }
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-6xl font-bold mb-6 text-balance">
            <span className="shimmer-text">Investment</span> <span className="text-primary">Portal</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
            Join us in revolutionizing campus food experiences. Invest in Star Pops and be part of Ghana's next big food
            success story.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="glass-effect border-primary/20 text-center">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-2">{businessData.projections.projectedYearlyGrowth}%</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <Card className="glass-effect border-primary/20">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Calculate your potential returns based on our growth projections and investment terms.
              </p>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Minimum investment: GHS {businessData.investmentTerms.minimumInvestment.toLocaleString()}
                </p>
              </div>
              ...
              {calculatedReturn && (
                <div className="space-y-4">
                  <div className="p-6 bg-primary/10 rounded-lg border border-primary/20">
                    <div className="text-center">
                      <div className="text-sm text-muted-foreground mb-2">Projected 2-Year Return</div>
                      <div className="text-4xl font-bold text-primary mb-2">
                        GHS {calculatedReturn.toLocaleString()}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {Math.round(
                          ((calculatedReturn - Number.parseFloat(investmentAmount)) /
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="p-3 bg-secondary/10 rounded border border-secondary/20">
                      <div className="text-muted-foreground">Your Investment</div>
                      <div className="font-bold text-secondary">
                        GHS {Number.parseFloat(investmentAmount).toLocaleString()}
                      </div>
                    </div>
                    <div className="p-3 bg-primary/10 rounded border border-primary/20">
                      <div className="text-muted-foreground">Potential Profit</div>
                      <div className="font-bold text-primary">
                        GHS {(calculatedReturn - Number.parseFloat(investmentAmount)).toLocaleString()}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 bg-muted/20 rounded-lg border border-border/50">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• {businessData.investmentTerms.discountRate}% discount rate on future equity rounds</li>
                  <li>• Valuation cap: GHS {businessData.investmentTerms.valuationCap.toLocaleString()}</li>
                  <li>• Minimum investment: GHS {businessData.investmentTerms.minimumInvestment.toLocaleString()}</li>
          ...
          <Card className="glass-effect border-secondary/20">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Ready to invest? Fill out your details to generate a personalized investment proposal.
              </p>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="outline" className="w-full bg-transparent border-primary/30">
                      View Full Investment Terms
                    </Button>
                  </DialogTrigger>
                  <DialogContent className="max-w-2xl glass-effect">
                    <DialogHeader>
                      <DialogTitle className="text-2xl">Complete Investment Terms</DialogTitle>
                    </DialogHeader>
                    <div className="space-y-4 max-h-96 overflow-y-auto">
                      <div className="p-4 bg-primary/10 rounded-lg">
                        <h4 className="font-semibold mb-2">Investment Structure</h4>
                        <p className="text-sm text-muted-foreground">{businessData.investmentTerms.fullTerms}</p>
                      </div>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="p-4 bg-secondary/10 rounded-lg">
                          ...
                          <ul className="text-sm text-muted-foreground space-y-1">
                            <li>
                              • Total Revenue: GHS {businessData.financials.summary.totalRevenue.toLocaleString()}
                            </li>
                            <li>• Total Profit: GHS {businessData.financials.summary.totalProfit.toLocaleString()}</li>
                            <li>
                              • Profit Margin:{" "}
                              {Math.round(
                            ...
                            <li>• Active Days: {businessData.financials.summary.totalDaysActive}</li>
                          </ul>
                        </div>
                        <div className="p-4 bg-primary/10 rounded-lg">
                          ...
                          <ul className="text-sm text-muted-foreground space-y-1">
                            ...
                            <li>• Growth Rate: {businessData.projections.projectedYearlyGrowth}%</li>
                      ...
                      <div className="p-4 bg-muted/20 rounded-lg">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>CEO Salary: {businessData.allocation.ceoSalary}%</div>
                          <div>Employee Wages: {businessData.allocation.employeeWages}%</div>
                          <div>Operations: {businessData.allocation.operationalCost}%</div>
                          <div>Reinvestment: {businessData.allocation.reinvestment}%</div>
                        </div>
                      </div>
                    </div>
                  </DialogContent>
                ...
                <Button
                  ...
                  className="w-full glow-border text-lg py-4"
                  disabled={!investmentAmount || !investorName || !investorEmail}
                >
              ...
              <div className="text-sm text-muted-foreground">
                ...
                <ul className="space-y-1 text-xs">
                  <li>• Receive follow-up communications about this investment opportunity</li>
                  <li>• Provide accurate information for due diligence purposes</li>
                  <li>• Understand that this is not a binding commitment to invest</li>
                </ul>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="glass-effect border-primary/20">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  GHS {businessData.financials.summary.totalRevenue.toLocaleString()} revenue in just{" "}
                  {businessData.financials.summary.totalDaysActive} days of part-time operation demonstrates strong
                  market demand.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect border-secondary/20">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  KNUST campus provides a consistent customer base of thousands of students with proven demand for
            ...
            <Card className="glass-effect border-primary/20">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Our business model is easily replicable across multiple campuses, creating opportunities for rapid
                  expansion.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="mt-20 text-center">
          <Card className="glass-effect border-primary/20 max-w-2xl mx-auto">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold mb-4">Ready to Discuss Your Investment?</h3>
              <p className="text-muted-foreground mb-6">
                Have questions about the opportunity? Want to schedule a call? We're here to help.
              </p>
