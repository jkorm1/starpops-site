      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-6xl font-bold mb-6 text-balance">
            <span className="shimmer-text">Get in</span> <span className="text-primary">Touch</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
            Ready to join the Star Pops journey? Have questions about our business or investment opportunities? We'd
          ...
          <Card className="glass-effect border-primary/20">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Submit Button */}
                <Button type="submit" className="w-full glow-border text-lg py-4" disabled={isSubmitting}>
                  {isSubmitting ? (
                    <>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Available Mon-Fri, 9AM-6PM GMT</p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="glass-effect border-primary/20">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-primary mb-4">How can I invest in Star Pops?</h3>
                <p className="text-muted-foreground">
                  Visit our Investment Portal to calculate potential returns and generate a personalized investment
                  proposal. Our minimum investment is GHS 5,000 with attractive terms for early investors.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect border-secondary/20">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-secondary mb-4">Do you offer franchise opportunities?</h3>
                <p className="text-muted-foreground">
                  Yes! We're planning to expand to other universities across Ghana. Contact us to learn about franchise
                  opportunities and partnership models for your campus.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect border-primary/20">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-primary mb-4">What makes Star Pops different?</h3>
                <p className="text-muted-foreground">
                  We focus on premium quality, innovative flavors, and exceptional customer experience. Our proven
                  business model and strong financial performance set us apart from competitors.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect border-secondary/20">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold text-secondary mb-4">Can I schedule a campus visit?</h3>
                <p className="text-muted-foreground">
                  We welcome potential investors and partners to visit our operations at KNUST. Contact us to arrange a
                  tour and see our business in action.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="glass-effect border-primary/20 max-w-3xl mx-auto">
            <CardContent className="p-12">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Whether you're interested in investing, partnering, or just learning more about Star Pops, we're here to
                help make it happen.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button className="glow-border text-lg px-8 py-4">Start a Conversation</Button>
                <Button variant="outline" className="bg-transparent text-lg px-8 py-4">
