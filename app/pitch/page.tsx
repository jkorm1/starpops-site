...
export default function PitchPage() {
  ...
  const allocationData = [
    { name: "CEO Salary", value: businessData.allocation.ceoSalary, color: "rgba(59, 130, 246, 0.8)" },
    { name: "Employee Wages", value: businessData.allocation.employeeWages, color: "rgba(251, 191, 36, 0.8)" },
    { name: "Operations", value: businessData.allocation.operationalCost, color: "rgba(34, 197, 94, 0.8)" },
    { name: "Reinvestment", value: businessData.allocation.reinvestment, color: "rgba(168, 85, 247, 0.8)" },
  ]
  ...
  const slides: PitchSlide[] = [
    {
      ...
      content: (
        <div className="text-center space-y-8">
          <div className="w-32 h-32 bg-primary rounded-full glow-border mx-auto flex items-center justify-center float-animation">
            <span className="text-4xl font-bold text-primary-foreground">SP</span>
          </div>
          <div className="space-y-4">
            <h2 className="text-6xl font-bold shimmer-text">{businessData.company.name}</h2>
            <p className="text-2xl text-secondary font-medium">{businessData.company.mission}</p>
            <p className="text-xl text-muted-foreground">{businessData.company.location}</p>
          </div>
        </div>
      ),
      background: "bg-gradient-to-br from-background via-background/95 to-primary/10",
    },
    {
      id: 2,
      title: "The Problem",
      content: (
        <div className="space-y-8">
          <h2 className="text-5xl font-bold text-center mb-12">The Campus Food Challenge</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="glass-effect border-red-500/20 p-8">
              <h3 className="text-2xl font-bold text-red-400 mb-4">Current Situation</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-12">
          <h2 className="text-5xl font-bold text-center">Premium Popcorn Experience</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="glass-effect border-primary/20 text-center p-8">
              ...
              <p className="text-muted-foreground">
                Fresh, artisanal popcorn made with the finest ingredients and innovative flavors
              </p>
            </Card>
            <Card className="glass-effect border-secondary/20 text-center p-8">
              ...
              <h3 className="text-2xl font-bold text-secondary mb-4">Strategic Location</h3>
              <p className="text-muted-foreground">
                Positioned at high-traffic campus areas for maximum visibility and accessibility
              </p>
            </Card>
            <Card className="glass-effect border-primary/20 text-center p-8">
              <div className="w-20 h-20 bg-primary/20 rounded-full mx-auto mb-6 flex items-center justify-center">
              ...
              <h3 className="text-2xl font-bold text-primary mb-4">Affordable Luxury</h3>
              <p className="text-muted-foreground">
                Premium experience at student-friendly prices, making quality accessible to all
              </p>
            </Card>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-12">
          <h2 className="text-5xl font-bold text-center">Proven Market Demand</h2>
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="glass-effect border-primary/20 p-8">
              <h3 className="text-3xl font-bold text-primary mb-8 text-center">Revenue Performance</h3>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={monthlyChartData}>
                  ...
                  />
                  <Bar dataKey="revenue" fill="rgba(59, 130, 246, 0.8)" name="Monthly Revenue" />
                </BarChart>
              </ResponsiveContainer>
            </Card>
            <div className="space-y-6">
              ...
              <Card className="glass-effect border-primary/20 p-6 text-center">
                ...
                <Badge variant="outline" className="mt-2 border-primary text-primary">
                  GHS {Math.round(businessData.operations.averageDailyRevenue)} Daily Avg
                </Badge>
              </Card>
              <Card className="glass-effect border-secondary/20 p-6 text-center">
                <div className="text-4xl font-bold text-secondary mb-2">
                  {Math.round(
                    (businessData.financials.summary.totalProfit / businessData.financials.summary.totalRevenue) * 100,
                  )}
                  %
                </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-12">
          <h2 className="text-5xl font-bold text-center">Scalable Revenue Model</h2>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <Card className="glass-effect border-primary/20 p-8">
                <h3 className="text-2xl font-bold text-primary mb-6">Revenue Streams</h3>
                <div className="space-y-4">
              ...
              <Card className="glass-effect border-secondary/20 p-8">
                <h3 className="text-2xl font-bold text-secondary mb-6">Key Metrics</h3>
            ...
            <Card className="glass-effect border-primary/20 p-8">
              <h3 className="text-2xl font-bold text-primary mb-6 text-center">Fund Allocation</h3>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    data={allocationData}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="glass-effect border-primary/20 p-8">
              <h3 className="text-3xl font-bold text-primary mb-8 text-center">Short Term (12 Months)</h3>
              <div className="space-y-6">
            ...
            <Card className="glass-effect border-secondary/20 p-8">
              <h3 className="text-3xl font-bold text-secondary mb-8 text-center">Long Term (2-5 Years)</h3>
              <div className="space-y-6">
        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="glass-effect border-primary/20 p-8 text-center">
              <h3 className="text-2xl font-bold text-primary mb-4">Current Performance</h3>
              <div className="space-y-4">
                <div>
                  <div className="text-3xl font-bold text-primary">
                    GHS {Math.round(businessData.operations.averageDailyRevenue)}
                  </div>
                  <div className="text-sm text-muted-foreground">Daily Average (Part-time)</div>
                </div>
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    Total Revenue ({businessData.financials.summary.totalDaysActive} days)
                  </div>
                </div>
              </div>
            </Card>
            <Card className="glass-effect border-secondary/20 p-8 text-center">
              <h3 className="text-2xl font-bold text-secondary mb-4">Full-Time Projection</h3>
              <div className="space-y-4">
                <div>
                  <div className="text-3xl font-bold text-secondary">
                    GHS {businessData.operations.projectedDailyRevenue}
                  </div>
                  <div className="text-sm text-muted-foreground">Projected Daily Revenue</div>
                </div>
                <div>
            ...
            <Card className="glass-effect border-primary/20 p-8 text-center">
              <h3 className="text-2xl font-bold text-primary mb-4">Annual Potential</h3>
              <div className="space-y-4">
                <div>
                  <div className="text-3xl font-bold text-primary">
          ...
          <Card className="glass-effect border-primary/20 p-8 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-center mb-6">Investment Impact</h3>
            <div className="grid md:grid-cols-2 gap-8 text-center">
              <div>
                <div className="text-4xl font-bold text-primary mb-2">
                  GHS {businessData.investmentTerms.minimumInvestment.toLocaleString()}
                </div>
      ...
      content: (
        <div className="space-y-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <Card className="glass-effect border-primary/20 p-8">
                <h3 className="text-2xl font-bold text-primary mb-6">Why Invest Now?</h3>
                <ul className="space-y-4 text-lg">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-muted-foreground">
                      Proven market demand with {businessData.projections.projectedYearlyGrowth}% growth potential
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-muted-foreground">Scalable business model across multiple campuses</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-secondary rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-muted-foreground">Experienced team with proven execution</span>
                  </li>
                </ul>
              </Card>
              <Card className="glass-effect border-secondary/20 p-8">
                <h3 className="text-2xl font-bold text-secondary mb-6">Investment Terms</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-secondary/10 rounded-lg">
                  ...
                  <div className="flex justify-between items-center p-4 bg-primary/10 rounded-lg">
                    ...
                    <span className="text-primary font-bold">
                      GHS {businessData.investmentTerms.valuationCap.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-secondary/10 rounded-lg">
                    <span className="font-medium">Discount Rate</span>
                    <span className="text-secondary font-bold">{businessData.investmentTerms.discountRate}%</span>
                  </div>
                </div>
              </Card>
            </div>
            <div className="flex flex-col justify-center items-center space-y-8">
              <div className="text-center">
                ...
                <p className="text-xl text-muted-foreground mb-8">Be part of Ghana's next big food success story</p>
              </div>
              <div className="space-y-4 w-full max-w-sm">
                <Button className="w-full glow-border text-lg py-4" size="lg">
                  Calculate Your Returns
                </Button>
                <Button variant="outline" className="w-full bg-transparent text-lg py-4" size="lg">
                  Download Full Proposal
                </Button>
                <Button variant="ghost" className="w-full text-lg py-4" size="lg">
                  Schedule a Meeting
                </Button>
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Slide Content */}
      <div
        className={`min-h-screen flex items-center justify-center p-8 ${slides[currentSlide].background || "bg-background"}`}
      >
        <div className="container mx-auto max-w-7xl">{slides[currentSlide].content}</div>
      </div>
      ...
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
        <Card className="glass-effect border-primary/20 p-4">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" onClick={prevSlide} className="hover:bg-primary/20">
            ...
            <Button variant="ghost" size="sm" onClick={nextSlide} className="hover:bg-primary/20">
              <ChevronRight className="w-5 h-5" />
            </Button>

            <div className="w-px h-6 bg-border mx-2" />

            <Button variant="ghost" size="sm" onClick={toggleAutoPlay} className="hover:bg-secondary/20">
      ...
      <div className="fixed top-8 left-8 z-40">
        <Card className="glass-effect border-primary/20 p-4">
          <h1 className="text-2xl font-bold text-primary">{slides[currentSlide].title}</h1>
          {slides[currentSlide].subtitle && <p className="text-muted-foreground">{slides[currentSlide].subtitle}</p>}
        </Card>
      </div>
      ...
      <div className="fixed top-8 right-8 z-40">
        <Card className="glass-effect border-secondary/20 p-3">
          <div className="text-xs text-muted-foreground">Use ← → keys or click controls to navigate</div>
        </Card>
      </div>
    </div>
  )
